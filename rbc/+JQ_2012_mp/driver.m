...
M_.mapping.c.eqidx = [1 2 3 4 6 7 ];
M_.mapping.n.eqidx = [1 3 5 6 8 9 ];
M_.mapping.w.eqidx = [1 3 5 8 ];
M_.mapping.k.eqidx = [5 6 8 9 ];
M_.mapping.Rf.eqidx = [7 8 9 12 ];
M_.mapping.Rhh.eqidx = [2 3 12 ];
M_.mapping.m.eqidx = [3 4 12 ];
M_.mapping.d.eqidx = [3 5 6 7 8 ];
M_.mapping.b.eqidx = [3 4 8 9 12 ];
M_.mapping.mu.eqidx = [5 6 7 ];
M_.mapping.z.eqidx = [5 6 8 9 10 ];
M_.mapping.xi.eqidx = [6 7 9 11 ];
M_.mapping.g.eqidx = [1 2 12 13 ];
...
save('JQ_2012_mp_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('JQ_2012_mp_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('JQ_2012_mp_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('JQ_2012_mp_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('JQ_2012_mp_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('JQ_2012_mp_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('JQ_2012_mp_results.mat', 'oo_recursive_', '-append');
end
