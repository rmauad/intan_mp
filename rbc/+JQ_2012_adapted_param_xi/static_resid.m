...
if T_flag
    T = JQ_2012_adapted_param_xi.static_resid_tt(T, y, x, params);
end
residual = zeros(9, 1);
...
residual(4) = lhs - rhs;
lhs = params(2)*(1-params(4)+T(6)*T(7))+(1+2*params(6)*(y(6)-(y(6))))*y(8)*params(12);
rhs = 1;
residual(5) = lhs - rhs;
lhs = params(2)*y(5)+(1+2*params(6)*(y(6)-(y(6))))*y(8)*params(12)*y(5)*(1-params(5))/(y(5)-params(5));
rhs = 1;
residual(6) = lhs - rhs;
residual(7) = y(7)/y(5)+y(4)*(1-params(4))+T(7)*y(9)*T(3)-y(3)*y(2)-y(7)-y(4)-(y(6)+params(6)*(y(6)-(y(6)))^2);
lhs = params(12)*(y(4)-y(7)*(1-params(5))/(y(5)-params(5)));
rhs = T(7)*y(9)*T(3);
residual(8) = lhs - rhs;
lhs = log(y(9)/(y(9)));
