//Same as reg_inv_v1, but changing the dependent and independent variables.
...
xtreg inv_tot_rev c.cre_at##d_med_1985 i.year if year >= 1986,fe cluster(ff_indust) 
...
xtreg inv_tang_rev c.cre_at##d_quar_1985 c.L.sales_gr c.cash_at i.year if year >= 1986,fe cluster(ff_indust) 
// outreg2 using debt_at.tex, append label drop(i.year) dec(3) nocons alpha(0.01, 0.05, 0.1, 0.15) symbol(***, **, *, +)
