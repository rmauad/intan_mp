...
gen lag_ppegt = L.ppegt //gross, but net is ppent
gen inv_ppe = inv_tot/lag_ppegt
gen fatb_ppe = fatb/lag_ppegt
...
xtreg inv_ppe c.fatb_ppe##d_med_1985 c.L.sales_gr c.cash_at i.year if year >= 1986,fe cluster(ff_indust) 
//outreg2 using debt_at.tex, replace label drop(i.year) dec(3) nocons alpha(0.01, 0.05, 0.1, 0.15) symbol(***, **, *, +)
xtreg inv_ppe c.fatb_ppe##d_terc_1985 c.L.sales_gr c.cash_at i.year if year >= 1986,fe cluster(ff_indust) 
// outreg2 using debt_at.tex, append label drop(i.year) dec(3) nocons alpha(0.01, 0.05, 0.1, 0.15) symbol(***, **, *, +)
xtreg inv_ppe c.fatb_ppe##d_quar_1985 c.L.sales_gr c.cash_at i.year if year >= 1986,fe cluster(ff_indust) 
// outreg2 using debt_at.tex, append label drop(i.year) dec(3) nocons alpha(0.01, 0.05, 0.1, 0.15) symbol(***, **, *, +)
xtreg inv_ppe c.fatb_ppe##d_quin_1985 c.L.sales_gr c.cash_at i.year if year >= 1986,fe cluster(ff_indust) 
// outreg2 using debt_at.tex, append label drop(i.year) dec(3) nocons alpha(0.01, 0.05, 0.1, 0.15) symbol(***, **, *, +)
xtreg inv_ppe c.fatb_ppe##d_dec_1985 c.L.sales_gr c.cash_at i.year if year >= 1986,fe cluster(ff_indust)
//outreg2 using debt_at.tex, append label drop(i.year) dec(3) nocons alpha(0.01, 0.05, 0.1, 0.15) symbol(***, **, *, +)
