...
xtreg capx_ppe c.ffrate_zlb_lag1#d_med_1989 L.sales_gr cash_at i.year if year >= 1990,fe cluster(ff_indust) 
xtreg capx_ppe c.ffrate_zlb_lag1#d_terc_1989 L.sales_gr cash_at i.year if year >= 1990,fe cluster(ff_indust) 
xtreg capx_ppe c.ffrate_zlb_lag1#d_quar_1989 L.sales_gr cash_at i.year if year >= 1990,fe cluster(ff_indust) 
xtreg capx_ppe c.ffrate_zlb_lag1#d_quin_1989 L.sales_gr cash_at i.year if year >= 1990,fe cluster(ff_indust) 
xtreg capx_ppe c.ffrate_zlb_lag1#d_dec_1989 L.sales_gr cash_at i.year if year >= 1990,fe cluster(ff_indust)
