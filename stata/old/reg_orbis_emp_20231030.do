...
est store Decile
esttab Median Tercile Quartile Quintile Decile using /homes/nber/mauadr/bulk/orbis.work/intan_mp/output/emp_Fffactor.tex, b(%9.3f) label replace se ar2 stats(N r2, fmt(0 %9.3f)) star(* 0.10 ** 0.05 *** 0.01) drop(*.year med tercile quartile quintile decile MP_S_Fffactor_lag1 MP_S_Fffactor_lag2 c.MP_S_Fffactor_lag1#c.med c.MP_S_Fffactor_lag1#c.tercile c.MP_S_Fffactor_lag1#c.quartile c.MP_S_Fffactor_lag1#c.quintile c.MP_S_Fffactor_lag1#c.decile)
