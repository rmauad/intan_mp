...
#Treating the data
data_intan <- data_intan %>% select(GVKEY, cusip, year, sic, xsga, sga, intan, at, ceq, dlc, dltt, ppegt, revt, che, org_cap_comp, lt, csho, prcc_f, sale, ib, dp, ppent, capx, pstkl, invt, emp, xint, CPI, GDP, Ind_prod, fatb, Founding, prcc_c, txdb, ppent, ib, dp, ppent) %>%
...
# d_1989 <- db_reg %>% filter(year == 1989) %>%
#   select(GVKEY, d_2terc_only_1989, d_3quar_only_1989, d_2quin_only_1989, d_3quin_only_1989, d_4quin_only_1989) %>%
# rename(d_2terc_1989 = d_2terc_only_1989, d_3quar_1989 = d_3quar_only_1989, d_2quin_1989 = d_2quin_only_1989, d_3quin_1989 = d_3quin_only_1989, d_4quin_1989 = d_4quin_only_1989)
