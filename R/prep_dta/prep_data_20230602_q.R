...
# CHECK WHICH COLUMNS HAVE TOO MANY NAS AND DO NOT USE THEM - THIS WILL DROP TOO MANY FIRMS (CHECK THE ORIGINAL data_intan_q)
# CHECK ORGANIZATION CAPITAL MEASURE.

data_intan_q_new <- data_intan_q %>% # select(GVKEY, cusip, year, sic, xsgaq, sga, intanq, atq, ceqq, dlcq, dlttq, ppegtq, revtq, cheq, org_cap_comp, ltq, cshoq, prccq, saleq, ibq, dpq, ppentq, capxy, pstkq, invtq, xintq, CPI, RGDP, Ind_prod) %>%
